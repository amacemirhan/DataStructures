...
public class FXMLController implements Initializable {
    ...
    public void ClickVeriYapilari(javafx.event.ActionEvent event) throws IOException{
    Parent veriYap = FXMLLoader.load(getClass().getResource("StackFXML.fxml"));
    Scene veriScene = new Scene(veriYap);
    Stage window=(Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(veriScene);
        window.show();
    }
